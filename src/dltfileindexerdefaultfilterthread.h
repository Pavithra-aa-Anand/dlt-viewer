...
class DltFileIndexerDefaultFilterThread :public QThread
{
    Q_OBJECT
public:
    DltFileIndexerDefaultFilterThread(QDltDefaultFilter *defaultFilter, QDltPluginManager *pluginManager, CDecodeCacheService *decodeCacheService, bool silentMode);
